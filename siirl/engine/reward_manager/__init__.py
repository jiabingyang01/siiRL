...
def __getattr__(name):
    ...
    if name == "LWMRewardManager":
        from .lwm import LWMRewardManager
        return LWMRewardManager
    raise AttributeError(f"module '{__name__}' has no attribute '{name}'")

__all__ = ["DAPORewardManager", "NaiveRewardManager", "EmbodiedRewardManager", "ParallelRewardManager", "LWMRewardManager"]
