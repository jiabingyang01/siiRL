...
Tokenizer = Any
RewardTensor = Any
AnyRewardManager = Union[NaiveRewardManager, DAPORewardManager, ParallelRewardManager, EmbodiedRewardManager, LWMRewardManager]
...
def create_reward_manager(
    ...
    **reward_kwargs,
    ...
    default_compute_score_map = {
        ...
        "lwm": None,       # Will be loaded lazily if needed
    }
    ...
    if compute_score_fn is None:
        ...
        if sandbox_url:
            ...
            if compute_score_fn is None and reward_manager_name == "lwm":
                ...
                logger.info("Loaded LWM-Reward function (step-level dense reward)")
